...
class __TwigTemplate_88a4f591a00559bfe1b87dbc26ef3c8ffb2e0c5a268682b50fa0c5f2853fbaad extends Twig_Template
{
    ...
    <span class=\"icon\"><img src=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bundle\TwigBundle\Extension\AssetsExtension')->getAssetUrl("bundles/webprofiler/images/profiler/logger.png"), "html", null, true);
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                if (($this->getAttribute($context["log"], "priority", array()) >= (isset($context["priority"]) ? $context["priority"] : $this->getContext($context, "priority")))) {
                    ...
                    if (($this->getAttribute($context["log"], "context", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($context["log"], "context", array())))) {
                        ...
                        // line 64
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\YamlExtension')->encode($this->getAttribute($context["log"], "context", array())), "html", null, true);
                        echo "
                        </small>
                    ";
                    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "WebProfilerBundle:Collector:logger.html.twig", "/var/www/FileUpload/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
