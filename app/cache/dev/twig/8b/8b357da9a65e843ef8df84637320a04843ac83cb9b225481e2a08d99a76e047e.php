...
class __TwigTemplate_d6cc21dbe9707abf5563d6fcede3ef230c5e4e55650e054bb0e6cf87880e6eb4 extends Twig_Template
{
...
";
    ...
    public function block_panel($context, array $blocks = array())
    {
        ...
        if (("explain" == (isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")))) {
            // line 44
            echo "        ";
            echo $this->env->getExtension('actions')->renderAction("DoctrineBundle:Profiler:explain", array("token" =>             // line 45
        ...
        ";
                ...
                foreach ($context['_seq'] as $context["i"] => $context["query"]) {
                    ...
                    echo "\">
                                    ";
                    // line 74
                    echo $this->env->getExtension('Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension')->minifyQuery($this->getAttribute($context["query"], "sql", array()));
                    echo "
                                </span>
                            </div>
                            <code id=\"code-";
...
{% endblock %}
", "DoctrineBundle:Collector:db.html.twig", "/var/www/FileUpload/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views/Collector/db.html.twig");
    }
}
